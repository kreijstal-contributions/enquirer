...
const readline = this.window===this?require('@kreijstal/readline-browser'):require('readline');
...
keypress.listen = (options = {}, onKeypress) => {
  ...
  let rl = readline.createInterface({ terminal: true, input: stdin, output:options.stdout,options.completer,options.history,options.historySize,options.signal,options.removeHistoryDuplicates,options.prompt });
